...
#define V2RAY_BOX_PLUGIN(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), v2ray_box_plugin_get_type(), \
                              V2rayBoxPlugin))
...
static void v2ray_box_plugin_handle_method_call(
    V2rayBoxPlugin* self,
...
static void method_call_cb(FlMethodChannel* channel, FlMethodCall* method_call,
                           gpointer user_data) {
  V2rayBoxPlugin* plugin = V2RAY_BOX_PLUGIN(user_data);
  v2ray_box_plugin_handle_method_call(plugin, method_call);
}
